...
from dataset_vs_seg import NiftiImageGenerator, NiftiPairImageGenerator
import argparse
import torch
...
parser.add_argument('--input_size', type=int, default=512) # (512, 512, 120) 
parser.add_argument('--depth_size', type=int, default=120)
...
parser.add_argument('-r', '--resume_weight', type=str, default="") #empty currently, need to initialize weights
