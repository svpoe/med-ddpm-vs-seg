...
parser.add_argument('-i', '--inputfolder', type=str, default="dataset/vs_seg/seg/")  #"dataset/brats2021/seg")
...
parser.add_argument('-w', '--weightfile', type=str, default=f"model/model_brats.pt") #CHANGE to "model_vs.pt" for VS
...
input_transform = Compose([
    ...
    Lambda(lambda t: t.unsqueeze(0)), # why are we doing the unsqueeze step here?
